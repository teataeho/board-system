	...
	<%@ include file="../include/header.jsp" %>
		...
		<div class="container">
			...
			<div class="d-flex justify-content-center">
				...
				<form action='#' id="uptae" class="d-inline-flex flex-wrap align-items-center">
					<input class="me-1" type="radio" name="uptaeNm" value="한식"> 한식
					<input class="me-1" type="radio" name="uptaeNm" value="경양식"> 경양식
					<input class="me-1" type="radio" name="uptaeNm" value="일식"> 일식
					<input class="me-1" type="radio" name="uptaeNm" value="분식"> 분식
					<input class="me-1" type="radio" name="uptaeNm" value="중국식"> 중국식
					<input class="me-1" type="radio" name="uptaeNm" value="기타"> 기타
				</form>
			</div>
